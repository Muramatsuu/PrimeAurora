...
#[derive(Debug)]
pub struct PrimeAuroraProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PrimeAuroraProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PrimeAurora processing");
    
    let mut processor = PrimeAuroraProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PrimeAuroraProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PrimeAuroraProcessor::new(false);
